        ...
        <div className="flex flex-col sm:flex-row gap-3 items-start sm:items-center">
          ...
          <div className="relative">
            <input
              ...
              className="pl-10 pr-10 py-3 border-2 border-gray-200 rounded-xl text-sm w-full lg:w-64 focus:border-purple-500 focus:ring-2 focus:ring-purple-200 transition-all duration-200"
            />
