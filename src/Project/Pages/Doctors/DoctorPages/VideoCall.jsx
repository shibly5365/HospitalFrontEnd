...
import { notify } from "../../../../UnitsTemp/notification.jsx";
import {
  createVideoCall,
  endVideoCall,
  getVideoCallStatus,
} from "../../videoCallApi/videoCallApi.js";
...
export default function VideoCall({ 
  ...
  const handleStartCall = async () => {
    try {
      ...
      if (!data.roomId) {
        notify.error("Call not ready yet");
        return;
      }
...
console.log({
  enabled: appointment.videoCallEnabled,
  status: appointment.videoCallStatus,
  room: appointment.videoCallRoomId,
});
  return (
            ...
            <div className="w-full max-w-xl bg-white border rounded-2xl shadow-lg p-6">
              ...
              <div className="flex justify-end gap-3 mt-6">
                ...
                <button
                  ...
                  disabled={loading || (!canJoin && !isDoctor)}
                  className={`rounded-lg px-6 py-2 text-white ${
                    loading || (!canJoin && !isDoctor)
